...
const MoreOffer = () => {
  ...
  const extraServices = [
    ...
    { id: 3, icon: FaCodeMerge, title: 'Deployment & Implementation', desc: 'Our experts handle the complete deployment process — from installation and configuration to integration and performance tuning. We ensure your systems go live smoothly, with minimal downtime and maximum efficiency. RightMc is fully capable for efficient use of API to communicate external platforms for efficient data exchange and process automation.' },
